class User < ApplicationRecord
  ...
  # Normalize the identity field so lookups and uniqueness are not defeated by
  # casing or stray whitespace. Email is matched case-insensitively.
  ...
  # email-verification flow (see TODO / SECURITY notes).
